      ...
      <html dir="rtl">
        <head>
          ...
          <style>
            ...
            .header { border-bottom: 2px solid #B31B3D; padding-bottom: 1.25rem; margin-bottom: 2.5rem; display: flex; justify-content: space-between; align-items: flex-end; }
            .header h1 { margin: 0; color: #B31B3D; font-size: 1.8rem; font-weight: 800; }
            ...
            .notes-title { font-size: 0.75rem; font-weight: 900; text-transform: uppercase; color: #B31B3D; margin-bottom: 0.75rem; letter-spacing: 0.05em; border-bottom: 1px solid #e2e8f0; padding-bottom: 0.25rem; }
      ...
      <div className="flex flex-1 h-full overflow-hidden divide-x divide-x-reverse divide-black/5 dark:divide-white/5">
        ...
        <div className="flex-[3] flex flex-col justify-between p-6 bg-black/[0.02] dark:bg-black/20 relative select-none" onContextMenu={(e) => isRestricted && e.preventDefault()}>
          ...
          <div className="flex-1 flex flex-col justify-center items-center text-center px-8 relative z-0">
            <span className="text-[10px] font-black uppercase tracking-widest text-primary mb-3 font-mono">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className={cn(
                  ...
                  !isPrintDisabled && "bg-primary hover:bg-primary/90 text-white shadow-glow-sm"
                )}
        ...
        <div className="flex-[1.2] flex flex-col justify-between p-6 bg-background">
          <div className="flex-1 flex flex-col">
            <div className="flex items-center gap-2 text-primary mb-4 border-b border-black/5 dark:border-white/5 pb-3">
            ...
            <textarea
              ...
              className="flex-1 w-full rounded-xl border border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.02] p-3 text-sm text-foreground outline-none resize-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 placeholder:text-muted-foreground/40 transition-all font-sans leading-relaxed"
          ...
          <div className="pt-4 border-t border-black/5 dark:border-white/5 mt-4 flex items-center justify-between">
            ...
            <Button size="sm" onClick={handleSaveNote} className="gap-1 bg-primary hover:bg-primary/90 text-white font-bold">
                  ...
                  <div className="flex h-full flex-col p-5">
                    ...
                    {m.type === "file" ? (
                      <button
                        ...
                        className="mt-auto inline-flex items-center gap-1.5 pt-3 text-sm font-medium text-primary hover:text-accent transition-colors text-start w-fit"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-auto inline-flex items-center gap-1.5 pt-3 text-sm font-medium text-primary/70 hover:text-primary"
                      >
